...
import PayloadSignature.A3Injection.iFrameInjection;
 ...
 * @author shacojx
 */
public class Scan_IFrameinjection {
    ...
    public boolean Scan(UrlOb uri) {
        ...
        try{
            if(uri.getParam() != null){
                iFrameInjection ifr = new iFrameInjection();
                String[] payload = ifr.getArrPayXSS();
                ...
                if(cookie == null){
                    if(uri.getMethod().equalsIgnoreCase("get") && uri.getParam() != null){
                        ...
                        for(String p : payload){
                            ...
                            String sig = URLDecoder.decode(p, "UTF-8");
