...
import PayloadSignature.A3Injection.HTMLInjection;
 ...
 * @author shacojx
 */
public class Scan_HTMLinjection {
    ...
    public boolean Scan(UrlOb uri) {
        ...
        try{
            if(uri.getParam() != null){
                HTMLInjection pghtml = new HTMLInjection();
                String[] payload = pghtml.getArrPayhtmli();
