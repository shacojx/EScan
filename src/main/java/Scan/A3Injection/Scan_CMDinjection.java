...
import PayloadSignature.A3Injection.OSCommandInjection;
    ...
    public boolean Scan(UrlOb uri) {
        ...
        try {
            if (uri.getParam() != null) {
                OSCommandInjection cli = new OSCommandInjection();
                String[] payload = cli.getArrPayCMDi();
                String[] signature = cli.getArrSigCMDi();
