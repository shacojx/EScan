...
import PayloadSignature.A3Injection.PHPCodeInjection;
 ...
 * @author shacojx
 */
public class Scan_PHPInjection {
    ...
    public boolean Scan(UrlOb uri) {
        ...
        try {
            if (uri.getParam() != null) {
                PHPCodeInjection phpi = new PHPCodeInjection();
                String[] payload = phpi.getArrPayCI();
                String[] signature = phpi.getArrSigCI();
