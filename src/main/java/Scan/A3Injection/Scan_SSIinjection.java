...
import PayloadSignature.A3Injection.ServerSideIncludesInjection;
 ...
 * @author shacojx
 */
public class Scan_SSIinjection {
    ...
    public boolean Scan(UrlOb uri) {
        ...
        try {
            if (uri.getParam() != null) {
                ServerSideIncludesInjection ssii = new ServerSideIncludesInjection();
                String[] payload = ssii.getArrPaySSI();
                String[] signature = ssii.getArrSigSSI();
